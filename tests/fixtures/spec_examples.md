<!-- Vendored from MobilityData/transit-operational-data-standard
     docs/en/spec/examples.md @ 523f19f. Do not edit; refresh by re-copying.
     Used by tests/test_spec_examples.py as a conformance check. -->
