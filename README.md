...
No problems found.
Rule-set coverage: 40 of 44 checks ran. Checks skipped: 3 opt-in rule not enabled (use --enable).
...
No problems found.
Rule-set coverage: 26 of 44 checks ran. Checks skipped: 16 no companion GTFS feed was provided; 1 opt-in rule not enabled (use --enable).
